...
public class Clock {
   ...
   */
   public double validateAngleArg( String argValue ) throws NumberFormatException {
      angleArg = Double.parseDouble(argValue);
   ...
   */
   public double getHourHandAngle() {
      double hourAngle = ( durationSec * HOUR_HAND_DEGREES_PER_SECOND ) % 360;
      return hourAngle;
   }
   ...
   */
   public double getMinuteHandAngle() {
      double minuteAngle = ( durationSec * MINUTE_HAND_DEGREES_PER_SECOND ) % 360;
      return minuteAngle;
   }
   ...
   */
   public double getHandAngle() {
      ...
      double handsDifference = Math.abs( hourAngle - minuteAngle );
      return handsDifference;
   }
