 ...
 *  Purpose       :  A test harness file for testing out the methods in the "StringStuffEmpty.java" class
 *  Author        :  B.J. Johnson
 *  Date          :  2017-01-25
...
public class StringStuffTester {
   ...
   */
   ...
   //   try { System.out.println( (0 == StringStuffEmpty.removeDupes( "xylophones" ).compareTo( "xylophnes" )) ? "got it" : "don't got it" ); }
   //   catch( Exception e ) { System.out.println ( false ); }
   ...
   //   catch( Exception e ) { System.out.println ( false ); }
    ...
    //  try { System.out.println( (0 == StringStuffEmpty.removeDupes( "AmanAplanAcAnalpAnamA" ).compareTo("Amanplc")) ? "got it" : "don't got it" ); }
    //  catch( Exception e ) { System.out.println ( false ); }

     // System.out.print( "   Testing 'shutTheFrontDoor11233455677890' should return shutTeFronD1234567890: " );
     // try { System.out.println( (0 == StringStuffEmpty.removeDupes( "shutTheFrontDoor11234567890" ).compareTo("shutTeFronD1234567890")) ? "got it" : "don't got it" ); }
     // catch( Exception e ) { System.out.println ( false ); }
